defmodule GameBacklog.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: GameBacklog.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    GameBacklogWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
